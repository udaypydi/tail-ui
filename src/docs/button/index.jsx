...
function ButtonDoc() {
  return (
    <div className="p-10">
      ...
      <p className="w-full border-b-2 pb-1 mt-5 mb-10 text-blue-700 text-2xl">
        Props
      </p>
      <div className="m-2 w-11/12 shadow p-5">
        ...
        <div className="flex justify-between border-b-2 p-5">
          ...
          <p className="text-left w-2/6">
            A custom text that is to be displayed inside the button
          </p>
        </div>
        <div className="flex justify-between border-b-2 p-5">
